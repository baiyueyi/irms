...
func newPage(db *gorm.DB, opts ...gen.DOOption) page {
	...
	_page.RoutePath = field.NewString(tableName, "route_path")
	_page.Source = field.NewString(tableName, "source")
	_page.Status = field.NewString(tableName, "status")
...
func (p *page) updateTableName(table string) *page {
	...
	p.RoutePath = field.NewString(table, "route_path")
...
func (p *page) fillFieldMap() {
	...
	p.fieldMap["route_path"] = p.RoutePath
