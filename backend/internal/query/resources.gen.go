...
func newResource(db *gorm.DB, opts ...gen.DOOption) resource {
	...
	_resource.Key = field.NewUint64(tableName, "key")
	_resource.Name = field.NewString(tableName, "name")
	_resource.Type = field.NewString(tableName, "type")
	_resource.Address = field.NewString(tableName, "address")
	_resource.ServiceIdentifier = field.NewString(tableName, "service_identifier")
	_resource.RoutePath = field.NewString(tableName, "route_path")
	_resource.Status = field.NewString(tableName, "status")
...
func (r *resource) updateTableName(table string) *resource {
	...
	r.Key = field.NewUint64(table, "key")
	r.Name = field.NewString(table, "name")
	r.Type = field.NewString(table, "type")
	r.Address = field.NewString(table, "address")
	r.ServiceIdentifier = field.NewString(table, "service_identifier")
...
func (r *resource) fillFieldMap() {
	...
	r.fieldMap["service_identifier"] = r.ServiceIdentifier
