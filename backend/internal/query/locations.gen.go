...
func newLocation(db *gorm.DB, opts ...gen.DOOption) location {
	...
	_location.LocationType = field.NewString(tableName, "location_type")
	_location.Address = field.NewString(tableName, "address")
	_location.Status = field.NewString(tableName, "status")
...
func (l *location) WithContext(ctx context.Context) ILocationDo { return l.locationDo.WithContext(ctx) }
