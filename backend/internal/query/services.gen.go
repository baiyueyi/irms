...
func newService(db *gorm.DB, opts ...gen.DOOption) service {
	...
	_service.ID = field.NewUint64(tableName, "id")
	_service.Name = field.NewString(tableName, "name")
	_service.ServiceKind = field.NewString(tableName, "service_kind")
	_service.HostID = field.NewUint64(tableName, "host_id")
	_service.EndpointOrIdentifier = field.NewString(tableName, "endpoint_or_identifier")
	_service.Port = field.NewInt32(tableName, "port")
	_service.Protocol = field.NewString(tableName, "protocol")
	_service.CloudVendor = field.NewString(tableName, "cloud_vendor")
	_service.CloudProductCode = field.NewString(tableName, "cloud_product_code")
...
type service struct {
	...
	ID                   field.Uint64
	Name                 field.String
	ServiceKind          field.String
	HostID               field.Uint64
	EndpointOrIdentifier field.String
	Port                 field.Int32
	Protocol             field.String
	CloudVendor          field.String
	CloudProductCode     field.String
	Status               field.String
...
func (s *service) updateTableName(table string) *service {
	...
	s.ServiceKind = field.NewString(table, "service_kind")
	s.HostID = field.NewUint64(table, "host_id")
	s.EndpointOrIdentifier = field.NewString(table, "endpoint_or_identifier")
	s.Port = field.NewInt32(table, "port")
	s.Protocol = field.NewString(table, "protocol")
	s.CloudVendor = field.NewString(table, "cloud_vendor")
	s.CloudProductCode = field.NewString(table, "cloud_product_code")
...
func (s *service) fillFieldMap() {
	...
	s.fieldMap["service_kind"] = s.ServiceKind
	s.fieldMap["host_id"] = s.HostID
	s.fieldMap["endpoint_or_identifier"] = s.EndpointOrIdentifier
	s.fieldMap["port"] = s.Port
	s.fieldMap["protocol"] = s.Protocol
	s.fieldMap["cloud_vendor"] = s.CloudVendor
	s.fieldMap["cloud_product_code"] = s.CloudProductCode
