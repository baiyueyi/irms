...
func newEnvironment(db *gorm.DB, opts ...gen.DOOption) environment {
	...
	_environment.Code = field.NewString(tableName, "code")
	_environment.Name = field.NewString(tableName, "name")
	_environment.Status = field.NewString(tableName, "status")
	_environment.Description = field.NewString(tableName, "description")
